...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public long insertIntercambioElectronico5( String estatus ,String folio,String remolqueTraseraObservaciones,String Placas,String Sello1,String Sello2,
    ...
    public long insertIntercambioElectronico6( String estatus ,String folio, String remolqueLlantaDerJumbo,String remolqueChasisTraseroDerAmortiguador,String remolqueChasisTraseroDerBolsaAire,String remolqueChasisTraseroDerGavilan,
    ...
    public long insertIntercambioElectronico7 (String estatus ,String folio,String remolqueDerObservaciones ,String remolquePisoPLagas,String remolqueTechoPlagas,String remolqueDerLuces,
    ...
    public List<CintercambioElectronico> selectListIntercambioTerminado() {

        List<CintercambioElectronico> returnList = new ArrayList<>();

        String queryString = "SELECT * FROM " + TABLE_INTERCAMBIO + " WHERE fechaFin IS NOT null ";
    ...
    public List<CintercambioElectronico> selectIntercambio( String Zfolio) {
        ...
        String queryString = "SELECT * FROM " + TABLE_INTERCAMBIO + " WHERE = " + Zfolio;
